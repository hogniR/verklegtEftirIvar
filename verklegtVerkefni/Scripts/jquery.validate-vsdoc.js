...
$.extend($.validator, {
	...
	messages: {
		required: "Vinsamlegast fyllið út í reitinn",
		remote: "Vinsamlegast lagið reitinn",
		email: "Vinsamlegast sláið inn gilt netfang",
		url: "Vinsamlegast sláið inn gildan hlekk",
		date: "Vinsamlegast sláið inn gilda dagsetningu",
		dateISO: "Vinsamlegast sláið inn gilda dagsetningu",
		number: "Vinsamlegast sláið inn gilda tölu",
		digits: "Vinsamlegast sláið aðeins inn tölustafi",
